...
exp_statevarIndex = [ 107;   % 1: 11-HETE in Ecs (Lipid) (Bmdm_kdo_lipida_atp) (Data)
                      109;   % 2: 13,14-DIHYDRO-15-KETO-PGD2 in Ecs (Lipid) (Bmdm_kdo_lipida_atp) (Data)
                      113;   % 3: 15-HETE in Ecs (Lipid) (Bmdm_kdo_lipida_atp) (Data)
                      114;   % 4: 5-HETE in Ecs (Lipid) (Bmdm_kdo_lipida_atp) (Data)
                      115;   % 5: AA in Ecs (Lipid) (Bmdm_kdo_lipida_atp) (Data)
                      117;   % 6: LTB4 in Ecs (Lipid) (Bmdm_kdo_lipida_atp) (Data)
                      120;   % 7: PGD2 in Ecs (Lipid) (Bmdm_kdo_lipida_atp) (Data)
                      121;   % 8: PGE2 in Ecs (Lipid) (Bmdm_kdo_lipida_atp) (Data)
                      123;   % 9: PGJ2 in Ecs (Lipid) (Bmdm_kdo_lipida_atp) (Data)
                      126;   % 10: TXB2 in Ecs (Lipid) (Bmdm_kdo_lipida_atp) (Data)
                    ];
