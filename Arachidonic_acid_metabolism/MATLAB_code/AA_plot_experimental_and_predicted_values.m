...
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predictedExp_color);
ylim([0 max(max(Ecs_11_HETE(1:length(Ecs_11_HETE))),max(Ecs_11_HETE_exp_means+Ecs_11_HETE_exp_sds))*1.1]);
xlabel('time [min]');
...
Ecs_13_14_DIHYDRO_15_KETO_PGD2 = statevar(:,105);
...
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predictedExp_color);
ylim([0 max(max(Ecs_13_14_DIHYDRO_15_KETO_PGD2(1:length(Ecs_13_14_DIHYDRO_15_KETO_PGD2))),max(Ecs_13_14_DIHYDRO_15_KETO_PGD2_exp_means+Ecs_13_14_DIHYDRO_15_KETO_PGD2_exp_sds))*1.1]);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predictedExp_color);
ylim([0 max(max(Ecs_15_HETE(1:length(Ecs_15_HETE))),max(Ecs_15_HETE_exp_means+Ecs_15_HETE_exp_sds))*1.1]);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predictedExp_color);
ylim([0 max(max(Ecs_5_HETE(1:length(Ecs_5_HETE))),max(Ecs_5_HETE_exp_means+Ecs_5_HETE_exp_sds))*1.1]);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predictedExp_color);
ylim([0 max(max(Ecs_AA(1:length(Ecs_AA))),max(Ecs_AA_exp_means+Ecs_AA_exp_sds))*1.1]);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predictedExp_color);
ylim([0 max(max(Ecs_LTB4(1:length(Ecs_LTB4))),max(Ecs_LTB4_exp_means+Ecs_LTB4_exp_sds))*1.1]);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predictedExp_color);
ylim([0 max(max(Ecs_PGD2(1:length(Ecs_PGD2))),max(Ecs_PGD2_exp_means+Ecs_PGD2_exp_sds))*1.1]);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predictedExp_color);
ylim([0 max(max(Ecs_PGE2(1:length(Ecs_PGE2))),max(Ecs_PGE2_exp_means+Ecs_PGE2_exp_sds))*1.1]);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predictedExp_color);
ylim([0 max(max(Ecs_PGJ2(1:length(Ecs_PGJ2))),max(Ecs_PGJ2_exp_means+Ecs_PGJ2_exp_sds))*1.1]);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predictedExp_color);
ylim([0 max(max(Ecs_TXB2(1:length(Ecs_TXB2))),max(Ecs_TXB2_exp_means+Ecs_TXB2_exp_sds))*1.1]);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
ERMem_11_DEHYDRO_TXB2 = statevar(:,51);
...
Cyt_11_DEHYDRO_TXB2 = statevar(:,80);
...
Ecs_11_DEHYDRO_TXB2 = statevar(:,102);
...
Cyt_13_14_DIHYDRO_15_KETO_PGD2 = statevar(:,83);
...
Cyt_13_14_DIHYDRO_15_KETO_PGE2 = statevar(:,84);
...
Ecs_13_14_DIHYDRO_15_KETO_PGE2 = statevar(:,106);
...
Cyt_13_14_DIHYDRO_15_KETO_PGF2ALPHA = statevar(:,85);
...
Ecs_13_14_DIHYDRO_15_KETO_PGF2ALPHA = statevar(:,107);
...
Cyt_13_14_DIHYDRO_15_KETO_PGJ2 = statevar(:,86);
...
Ecs_13_14_DIHYDRO_15_KETO_PGJ2 = statevar(:,108);
...
%%%%%%%%%%%%%%%%%% Plot GolgiMem_5_HPETE in Bmdm_kdo_lipida_atp
indexSubplot = indexSubplot + 1;
if indexSubplot > (subplot_rows * subplot_cols)
  figure;
  indexSubplot = 1;
end
GolgiMem_5_HPETE = statevar(:,17);
isRealNumber = ~isnan(GolgiMem_5_HPETE);
GolgiMem_5_HPETE = GolgiMem_5_HPETE(isRealNumber);
current_time_2 = time_2(isRealNumber);
subplot(subplot_rows,subplot_cols,indexSubplot);
hold on;
title_name = {strrep('Bmdm_kdo_lipida_atp','_',' ');strrep('GolgiMem_5_HPETE','_',' ')};
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predicted_color);
plot(current_time_2,GolgiMem_5_HPETE,'-','Color',Bmdm_kdo_lipida_atp_predicted_color,'LineWidth',2);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
%%%%%%%%%%%%%%%%%% Plot ERMem_5_HPETE in Bmdm_kdo_lipida_atp
indexSubplot = indexSubplot + 1;
if indexSubplot > (subplot_rows * subplot_cols)
  figure;
  indexSubplot = 1;
end
ERMem_5_HPETE = statevar(:,56);
isRealNumber = ~isnan(ERMem_5_HPETE);
ERMem_5_HPETE = ERMem_5_HPETE(isRealNumber);
current_time_2 = time_2(isRealNumber);
subplot(subplot_rows,subplot_cols,indexSubplot);
hold on;
title_name = {strrep('Bmdm_kdo_lipida_atp','_',' ');strrep('ERMem_5_HPETE','_',' ')};
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predicted_color);
plot(current_time_2,ERMem_5_HPETE,'-','Color',Bmdm_kdo_lipida_atp_predicted_color,'LineWidth',2);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
%%%%%%%%%%%%%%%%%% Plot Cyt_5_HPETE in Bmdm_kdo_lipida_atp
indexSubplot = indexSubplot + 1;
if indexSubplot > (subplot_rows * subplot_cols)
  figure;
  indexSubplot = 1;
end
Cyt_5_HPETE = statevar(:,89);
isRealNumber = ~isnan(Cyt_5_HPETE);
Cyt_5_HPETE = Cyt_5_HPETE(isRealNumber);
current_time_2 = time_2(isRealNumber);
subplot(subplot_rows,subplot_cols,indexSubplot);
hold on;
title_name = {strrep('Bmdm_kdo_lipida_atp','_',' ');strrep('Cyt_5_HPETE','_',' ')};
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predicted_color);
plot(current_time_2,Cyt_5_HPETE,'-','Color',Bmdm_kdo_lipida_atp_predicted_color,'LineWidth',2);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
%%%%%%%%%%%%%%%%%% Plot Ecs_5_HPETE in Bmdm_kdo_lipida_atp
indexSubplot = indexSubplot + 1;
if indexSubplot > (subplot_rows * subplot_cols)
  figure;
  indexSubplot = 1;
end
Ecs_5_HPETE = statevar(:,111);
isRealNumber = ~isnan(Ecs_5_HPETE);
Ecs_5_HPETE = Ecs_5_HPETE(isRealNumber);
current_time_2 = time_2(isRealNumber);
subplot(subplot_rows,subplot_cols,indexSubplot);
hold on;
title_name = {strrep('Bmdm_kdo_lipida_atp','_',' ');strrep('Ecs_5_HPETE','_',' ')};
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predicted_color);
plot(current_time_2,Ecs_5_HPETE,'-','Color',Bmdm_kdo_lipida_atp_predicted_color,'LineWidth',2);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
ylim([0 max(Cyt_CA(1:length(Cyt_CA)))*1.1]);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
GolgiMem_PGF2ALPHA = statevar(:,26);
...
original_mRNA_expression = mRNA_initial_concentration(1);% save original mRNA initial concentration, since it will be mapped to protein concentration for better comparison
ERMem_ACSL1_predicted_0min = statevar(1,33);
...
original_mRNA_expression = mRNA_initial_concentration(2);% save original mRNA initial concentration, since it will be mapped to protein concentration for better comparison
ERMem_ACSL3_predicted_0min = statevar(1,34);
...
original_mRNA_expression = mRNA_initial_concentration(3);% save original mRNA initial concentration, since it will be mapped to protein concentration for better comparison
ERMem_ACSL4_predicted_0min = statevar(1,35);
...
original_mRNA_expression = mRNA_initial_concentration(4);% save original mRNA initial concentration, since it will be mapped to protein concentration for better comparison
ERMem_ACSL5_predicted_0min = statevar(1,36);
...
original_mRNA_expression = mRNA_initial_concentration(5);% save original mRNA initial concentration, since it will be mapped to protein concentration for better comparison
ERMem_ACSL6_predicted_0min = statevar(1,37);
...
ERMem_ALOX15_predicted_0min = statevar(1,38);
...
original_mRNA_expression = mRNA_initial_concentration(6);% save original mRNA initial concentration, since it will be mapped to protein concentration for better comparison
Cyt_ALOX15_predicted_0min = statevar(1,72);
...
ERMem_ALOX5_predicted_0min = statevar(1,39);
...
original_mRNA_expression = mRNA_initial_concentration(7);% save original mRNA initial concentration, since it will be mapped to protein concentration for better comparison
Cyt_ALOX5_predicted_0min = statevar(1,73);
...
Cyt_CBR1_predicted_0min = statevar(1,74);
...
Cyt_CBR3_predicted_0min = statevar(1,75);
...
ERMem_GANAB_predicted_0min = statevar(1,40);
...
Cyt_HPGD_predicted_0min = statevar(1,76);
...
Cyt_LTA4H_predicted_0min = statevar(1,78);
...
ERMem_LTC4S_predicted_0min = statevar(1,42);
...
original_mRNA_expression = mRNA_initial_concentration(15);% save original mRNA initial concentration, since it will be mapped to protein concentration for better comparison
ERMem_PLA2G4A_predicted_0min = statevar(1,43);
...
original_mRNA_expression = mRNA_initial_concentration(15);% save original mRNA initial concentration, since it will be mapped to protein concentration for better comparison
Cyt_PLA2G4A_predicted_0min = statevar(1,79);
...
original_mRNA_expression = mRNA_initial_concentration(16);% save original mRNA initial concentration, since it will be mapped to protein concentration for better comparison
ERMem_PTGDS_predicted_0min = statevar(1,44);
...
ERMem_PTGS1_predicted_0min = statevar(1,45);
...
original_mRNA_expression = mRNA_initial_concentration(19);% save original mRNA initial concentration, since it will be mapped to protein concentration for better comparison
ERMem_PTGS2_predicted_0min = statevar(1,46);
...
%%%%%%%%%%%%%%%%%% Plot ERMem_PTGS2DEGRADED in Bmdm_kdo_lipida_atp
indexSubplot = indexSubplot + 1;
if indexSubplot > (subplot_rows * subplot_cols)
  figure;
  indexSubplot = 1;
end
ERMem_PTGS2DEGRADED = statevar(:,47);
isRealNumber = ~isnan(ERMem_PTGS2DEGRADED);
ERMem_PTGS2DEGRADED = ERMem_PTGS2DEGRADED(isRealNumber);
current_time_2 = time_2(isRealNumber);
subplot(subplot_rows,subplot_cols,indexSubplot);
hold on;
title_name = {strrep('Bmdm_kdo_lipida_atp','_',' ');strrep('ERMem_PTGS2DEGRADED','_',' ')};
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predicted_color);
plot(current_time_2,ERMem_PTGS2DEGRADED,'-','Color',Bmdm_kdo_lipida_atp_predicted_color,'LineWidth',2);
ylim([0 max(ERMem_PTGS2DEGRADED(1:length(ERMem_PTGS2DEGRADED)))*1.1]);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
%%%%%%%%%%%%%%%%%% Plot ERMem_PTGS2ERTOGOLGI in Bmdm_kdo_lipida_atp
indexSubplot = indexSubplot + 1;
if indexSubplot > (subplot_rows * subplot_cols)
  figure;
  indexSubplot = 1;
end
ERMem_PTGS2ERTOGOLGI = statevar(:,48);
isRealNumber = ~isnan(ERMem_PTGS2ERTOGOLGI);
ERMem_PTGS2ERTOGOLGI = ERMem_PTGS2ERTOGOLGI(isRealNumber);
current_time_2 = time_2(isRealNumber);
subplot(subplot_rows,subplot_cols,indexSubplot);
hold on;
title_name = {strrep('Bmdm_kdo_lipida_atp','_',' ');strrep('ERMem_PTGS2ERTOGOLGI','_',' ')};
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predicted_color);
plot(current_time_2,ERMem_PTGS2ERTOGOLGI,'-','Color',Bmdm_kdo_lipida_atp_predicted_color,'LineWidth',2);
ylim([0 max(ERMem_PTGS2ERTOGOLGI(1:length(ERMem_PTGS2ERTOGOLGI)))*1.1]);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
%%%%%%%%%%%%%%%%%% Plot GolgiMem_PTGS2GOLGITOER in Bmdm_kdo_lipida_atp
indexSubplot = indexSubplot + 1;
if indexSubplot > (subplot_rows * subplot_cols)
  figure;
  indexSubplot = 1;
end
GolgiMem_PTGS2GOLGITOER = statevar(:,11);
isRealNumber = ~isnan(GolgiMem_PTGS2GOLGITOER);
GolgiMem_PTGS2GOLGITOER = GolgiMem_PTGS2GOLGITOER(isRealNumber);
current_time_2 = time_2(isRealNumber);
subplot(subplot_rows,subplot_cols,indexSubplot);
hold on;
title_name = {strrep('Bmdm_kdo_lipida_atp','_',' ');strrep('GolgiMem_PTGS2GOLGITOER','_',' ')};
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predicted_color);
plot(current_time_2,GolgiMem_PTGS2GOLGITOER,'-','Color',Bmdm_kdo_lipida_atp_predicted_color,'LineWidth',2);
ylim([0 max(GolgiMem_PTGS2GOLGITOER(1:length(GolgiMem_PTGS2GOLGITOER)))*1.1]);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
%%%%%%%%%%%%%%%%%% Plot ERMem_PTGS2RETURNED in Bmdm_kdo_lipida_atp
indexSubplot = indexSubplot + 1;
if indexSubplot > (subplot_rows * subplot_cols)
  figure;
  indexSubplot = 1;
end
ERMem_PTGS2RETURNED = statevar(:,49);
isRealNumber = ~isnan(ERMem_PTGS2RETURNED);
ERMem_PTGS2RETURNED = ERMem_PTGS2RETURNED(isRealNumber);
current_time_2 = time_2(isRealNumber);
subplot(subplot_rows,subplot_cols,indexSubplot);
hold on;
title_name = {strrep('Bmdm_kdo_lipida_atp','_',' ');strrep('ERMem_PTGS2RETURNED','_',' ')};
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predicted_color);
plot(current_time_2,ERMem_PTGS2RETURNED,'-','Color',Bmdm_kdo_lipida_atp_predicted_color,'LineWidth',2);
ylim([0 max(ERMem_PTGS2RETURNED(1:length(ERMem_PTGS2RETURNED)))*1.1]);
xlabel('time [min]');
ylabel({'concentration','[mol/l]'});
set(gca,'FontSize',15,'fontWeight','bold');
set(gca, 'linewidth', 1.5);
...
ERMem_TBXAS1_predicted_0min = statevar(1,50);
...
isNotNaN = ~isnan(statevar(:,72));
current_time_2 = time_2(isNotNaN);
n_ERMem_ALOX15 = statevar(isNotNaN,38) * 4.256858E-08;
n_Cyt_ALOX15 = statevar(isNotNaN,72) * 1.237002E-06;
...
isNotNaN = ~isnan(statevar(:,73));
current_time_2 = time_2(isNotNaN);
n_ERMem_ALOX5 = statevar(isNotNaN,39) * 4.256858E-08;
n_Cyt_ALOX5 = statevar(isNotNaN,73) * 1.237002E-06;
...
current_time_2 = time_2(isNotNaN);
n_ERMem_HPGDS = statevar(isNotNaN,41) * 4.256858E-08;
n_Cyt_HPGDS = statevar(isNotNaN,77) * 1.237002E-06;
...
isNotNaN = ~isnan(statevar(:,79));
current_time_2 = time_2(isNotNaN);
n_GolgiMem_PLA2G4A = statevar(isNotNaN,7) * 5.321072E-09;
n_ERMem_PLA2G4A = statevar(isNotNaN,43) * 4.256858E-08;
n_Cyt_PLA2G4A = statevar(isNotNaN,79) * 1.237002E-06;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Relative compartment localization for PTGS2RETURNED in Er_membrane
isNotNaN = ~isnan(statevar(:,49));
current_time_2 = time_2(isNotNaN);
n_GolgiMem_PTGS2 = statevar(isNotNaN,10) * 5.321072E-09;
n_GolgiMem_PTGS2GOLGITOER = statevar(isNotNaN,11) * 5.321072E-09;
n_ERMem_PTGS2 = statevar(isNotNaN,46) * 4.256858E-08;
n_ERMem_PTGS2DEGRADED = statevar(isNotNaN,47) * 4.256858E-08;
n_ERMem_PTGS2ERTOGOLGI = statevar(isNotNaN,48) * 4.256858E-08;
n_ERMem_PTGS2RETURNED = statevar(isNotNaN,49) * 4.256858E-08;
n_total_PTGS2RETURNED_Bmdm_kdo_lipida_atp = n_GolgiMem_PTGS2 + n_GolgiMem_PTGS2GOLGITOER + n_ERMem_PTGS2 + n_ERMem_PTGS2DEGRADED + n_ERMem_PTGS2ERTOGOLGI + n_ERMem_PTGS2RETURNED;
...
Percent_compartment = 100*n_GolgiMem_PTGS2./n_total_PTGS2RETURNED_Bmdm_kdo_lipida_atp;
subplot(subplot_rows,subplot_cols,indexSubplot);
hold on;
plot(current_time_2,Percent_compartment,'-','Color',Bmdm_kdo_lipida_atp_predicted_color,'LineWidth',2);
ylim([0 100]);
...
%%% Plot GolgiMem_PTGS2GOLGITOER vs Rest of 
indexSubplot = indexSubplot + 1;
if indexSubplot > (subplot_rows * subplot_cols)
  figure;
  indexSubplot = 1;
end
Percent_compartment = 100*n_GolgiMem_PTGS2GOLGITOER./n_total_PTGS2RETURNED_Bmdm_kdo_lipida_atp;
subplot(subplot_rows,subplot_cols,indexSubplot);
hold on;
plot(current_time_2,Percent_compartment,'-','Color',Bmdm_kdo_lipida_atp_predicted_color,'LineWidth',2);
ylim([0 100]);
title_name = {strrep('Bmdm_kdo_lipida_atp','_',' ');strcat(strrep('GolgiMem_PTGS2GOLGITOER','_',' '),' vs total (PTGS2 (PFG no. 28))')};
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predicted_color);
ylabel({'# Molecules','[%]'});
xlabel('time [min]');
set(gca,'FontSize',15,'fontWeight','bold');
...
Percent_compartment = 100*n_ERMem_PTGS2./n_total_PTGS2RETURNED_Bmdm_kdo_lipida_atp;
subplot(subplot_rows,subplot_cols,indexSubplot);
hold on;
plot(current_time_2,Percent_compartment,'-','Color',Bmdm_kdo_lipida_atp_predicted_color,'LineWidth',2);
ylim([0 100]);
...
%%% Plot ERMem_PTGS2DEGRADED vs Rest of 
indexSubplot = indexSubplot + 1;
if indexSubplot > (subplot_rows * subplot_cols)
  figure;
  indexSubplot = 1;
end
Percent_compartment = 100*n_ERMem_PTGS2DEGRADED./n_total_PTGS2RETURNED_Bmdm_kdo_lipida_atp;
subplot(subplot_rows,subplot_cols,indexSubplot);
hold on;
plot(current_time_2,Percent_compartment,'-','Color',Bmdm_kdo_lipida_atp_predicted_color,'LineWidth',2);
ylim([0 100]);
title_name = {strrep('Bmdm_kdo_lipida_atp','_',' ');strcat(strrep('ERMem_PTGS2DEGRADED','_',' '),' vs total (PTGS2 (PFG no. 28))')};
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predicted_color);
ylabel({'# Molecules','[%]'});
xlabel('time [min]');
set(gca,'FontSize',15,'fontWeight','bold');
...
%%% Plot ERMem_PTGS2ERTOGOLGI vs Rest of 
indexSubplot = indexSubplot + 1;
if indexSubplot > (subplot_rows * subplot_cols)
  figure;
  indexSubplot = 1;
end
Percent_compartment = 100*n_ERMem_PTGS2ERTOGOLGI./n_total_PTGS2RETURNED_Bmdm_kdo_lipida_atp;
subplot(subplot_rows,subplot_cols,indexSubplot);
hold on;
plot(current_time_2,Percent_compartment,'-','Color',Bmdm_kdo_lipida_atp_predicted_color,'LineWidth',2);
ylim([0 100]);
title_name = {strrep('Bmdm_kdo_lipida_atp','_',' ');strcat(strrep('ERMem_PTGS2ERTOGOLGI','_',' '),' vs total (PTGS2 (PFG no. 28))')};
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predicted_color);
ylabel({'# Molecules','[%]'});
xlabel('time [min]');
set(gca,'FontSize',15,'fontWeight','bold');
...
%%% Plot ERMem_PTGS2RETURNED vs Rest of 
indexSubplot = indexSubplot + 1;
if indexSubplot > (subplot_rows * subplot_cols)
  figure;
  indexSubplot = 1;
end
Percent_compartment = 100*n_ERMem_PTGS2RETURNED./n_total_PTGS2RETURNED_Bmdm_kdo_lipida_atp;
subplot(subplot_rows,subplot_cols,indexSubplot);
hold on;
plot(current_time_2,Percent_compartment,'-','Color',Bmdm_kdo_lipida_atp_predicted_color,'LineWidth',2);
ylim([0 100]);
title_name = {strrep('Bmdm_kdo_lipida_atp','_',' ');strcat(strrep('ERMem_PTGS2RETURNED','_',' '),' vs total (PTGS2 (PFG no. 28))')};
title(title_name,'FontWeight','bold','Color',Bmdm_kdo_lipida_atp_predicted_color);
ylabel({'# Molecules','[%]'});
xlabel('time [min]');
set(gca,'FontSize',15,'fontWeight','bold');
